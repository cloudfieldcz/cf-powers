...
digraph process {
    ...
    "Dispatch final code reviewer subagent (../requesting-code-review/code-reviewer.md)" -> "Use cf-powers:finishing-a-development-branch";
}
```
...
- At skill start, check for a ledger:
  `cat "$(git rev-parse --show-toplevel)/.cf-powers/sdd/progress.md"`. Tasks listed there
...
- Final whole-branch review: use cf-powers:requesting-code-review's [code-reviewer.md](../requesting-code-review/code-reviewer.md)
...
- **cf-powers:requesting-code-review** - Code review template for the final whole-branch review
